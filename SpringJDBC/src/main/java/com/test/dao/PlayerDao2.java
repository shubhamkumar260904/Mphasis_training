...
public class PlayerDao2 {
	...
	private final String insert_sql="insert into players(id,p_name,p_team,price) value(?,?,?,?)";
			
	private final String update_sql="update players set p_name=?, p_team=?, price=? where id= ?";
